...
## Project Structure
    ...
    ├── tupaia_legal_assist_29965  # Django project configurations
...
1. Clone this repo and `cd tupaia_legal_assist_29965`
...
2. Clone this repo and `cd tupaia_legal_assist_29965`
